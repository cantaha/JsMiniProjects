...
// ? foreach döngüsü dizilirde kullanılır.

let names = ["taha", "merve", "luna"];

names.forEach(function nameConsol(name) { //döngü içine fonksiyon vererek döngüyü fonksiyon ile kullanıyoruz. 
    console.log(name)
}
)
...
// let index = arabalar.indexOf("bmw");s
// if(index==0){
